					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="tab-content text-center">
								<div id="activeGraph_general" style="height: 300px; width: 100%;"></div>	
										...
										<div class="col-md-6 text-left">
											...
											<div class="goal-slide text-center">
												...
												<div class="goal-bar">
													...
													<div class="goal-mimeta_pts" style="left: calc(<?=$miMeta;?>% - 32px);"><?=$alumno->tests[$_POST["test"]]["puntaje_psu"];?> pts.</div>
